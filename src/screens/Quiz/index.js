...
import loadingAnimation from './animations/music.json';
  ...
  return (
    ...
    animate="show">
      ...
      <h5 style= {{
          ...
          { score > 4 && score < 8 && `Você o conhece, mas não o suficiente para ser um Fandom. Talvez na próxima se dê melhor! :)`}
